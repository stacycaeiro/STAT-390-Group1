...
def drop_metadata_columns(df, keywords=None, unique_thresh=3, length_thresh=30, uniformity_thresh=0.95):
    #print("🗂️ Checking for metadata columns to drop...")
    ...
    #print(f"🔑 Columns with metadata-like names: {name_based_cols}")
